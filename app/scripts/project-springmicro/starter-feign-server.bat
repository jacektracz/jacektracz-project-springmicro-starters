rem C:\lkd\ht\apps_devsripts\src\apps\lkd-devsripts\gibs\project-springmicro\starter-feign-server.bat
...
rem java -jar client/target/feign-eureka-hello-client-0.0.1-SNAPSHOT.jar
